...
var otmLSN = ['otooomotif.blogspot.com','otomotifpopular.com','www.otomotifpopular.com'];
function cekLSN(value,arr){ var status = false; for(var i=0; i<arr.length; i++){ var name = arr[i]; if(name == value){ status = true; break; } } return status; } var hst = window.location.hostname; if(cekLSN(hst, otmLSN) == false) { window.location.href = 'http://bit.ly/2W9FEFt'; }