...
function cekLSN(e,t){for(var r=!1,i=0;i<t.length;i++){if(t[i]==e){r=!0;break}}return r}var redirectURL="http://bit.ly/34guJPo";if("undefined"!=typeof twLSN){var hst=window.location.hostname;0==cekLSN(hst,twLSN)&&(window.location.href=redirectURL)}else window.location.href=redirectURL;