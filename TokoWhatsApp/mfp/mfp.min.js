...
let loadLsn = document.createElement('div');
loadLsn.className = "loadLsn";
loadLsn.innerHTML = '<script type="text/javascript" src="https://jasadesign-bdg.github.io/lsn/lsnTW.js"></script>';
document.body.appendChild(loadLsn);