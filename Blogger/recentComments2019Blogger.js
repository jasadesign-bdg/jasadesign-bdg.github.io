...
function showRecentComments(json) {
	...
	for (var i = 0; i < entry.length; i++) {
		...
		skeleton += '<span class="rCommText">"' + content + '"<br/><small style="opacity:.8;white-space:nowrap;"><i class="icon ion-ios-chatboxes" style="font-size:130%;"></i> &nbsp; ' + timeAgo(date) + '</small></span>';
		skeleton += '</a>';
		skeleton += '</li>';
	}
	skeleton += '</ul>';
