...
function showRecentComments(json) {
	...
	for (var i = 0; i < entry.length; i++) {
		...
		skeleton += '<div class="rCommText">"' + content + '"<br/><small style="opacity:.8;white-space:nowrap;"><i class="icon ion-ios-chatboxes" style="font-size:120%;"></i> &nbsp; <a href='+link+'>' + timeAgo(date) + '</a></small></div>';
		skeleton += '</div>';
		skeleton += '</li>';
	}
	skeleton += '</ul>';
